...
# tambem para não confundir podemos separar este código acima em várias partes
# este código tem o mesmo resultado que o código acima porem está fracionado
